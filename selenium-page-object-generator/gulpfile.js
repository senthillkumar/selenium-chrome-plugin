...
gulp.task('chrome:css', [ 'chrome:css:popup' ], function(cb) {
    cb();
});
...
gulp.task('chrome:html', [ 'chrome:html:popup' ], function(cb) {
    cb();
});
...
gulp.task('chrome:js', [ 'chrome:js:generator', 'chrome:js:popup','chrome:js:content' ], function(cb) {
    cb();
});
